...
class BasicTokenizer:
    ...
    def decode(self, tokens):
        ...
        return b"".join(vocab[idx] for idx in tokens)
...
print( """Copy paste of the Wikipedia article on Taylor Swift, as of Feb 16, 2024.
---
...
(Top)
Life and career
Toggle Life and career subsection""" ==t.decode(t.encode("""Copy paste of the Wikipedia article on Taylor Swift, as of Feb 16, 2024.
---
